    ...
    return (
        <div className="flex flex-1 w-full justify-center items-end">
            <div className="w-full sm:w-auto font-bold text-white text-4xl">
                <div className="w-full sm:w-[682px] h-[88px] bg-[#616061] rounded-[80px] sm:rounded-[40px] p-4">
                    <div className="flex justify-between items-center gap-2">
                        <button className="hidden sm:flex bg-white rounded-[28px] w-[56px] h-[56px] justify-center items-center">
                        ...
                        <div className="w-[100px] sm:w-[300px] flex flex-grow h-[56px] bg-[#d6d7d6] rounded-[32px] sm:rounded-[28px] items-center px-1 gap-2">
                            ...
                            <div className="flex justify-end items-center">
                                <button className="hidden bg-white rounded-full w-[48px] h-[48px] sm:flex justify-center items-center shadow-lg">
