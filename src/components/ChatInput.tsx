        ...
        <div className="w-full sm:w-auto font-bold text-white text-4xl">
            <div className="w-full bg-[#5c5d5d]  sm:w-[682px] rounded-[80px] sm:rounded-[40px] p-4 flex flex-col gap-3">
                ...
                <div className="flex justify-between items-center gap-2">
                    <button className="hidden sm:flex bg-[#F6F6F6] rounded-[28px] w-[56px] h-[56px] justify-center items-center" style={{boxShadow: '0px 1px 3px 1px rgba(0, 0, 0, 0.15), 0px 1px 2px rgba(0, 0, 0, 0.3)'}} onClick={() => setChatModal(!chatModal)}>
                    ...
                    <div className=" bg-white w-[100px] sm:w-[300px] flex flex-grow h-[56px] sm:bg-[#d6d7d6] rounded-[32px] sm:rounded-[28px] items-center px-1 gap-2">
                        <input 
                            type="text" 
                            className="px-3 flex-1 bg-transparent focus:outline-none custom-input-text placeholder:weight[400] placeholder:text-[#141414]" 
                            style={{
                                fontFamily: 'Outfit',
                                fontWeight: 400,
                                fontSize: '16px',
                        ...
                        <div className="flex justify-end items-center">
                            <button className="hidden bg-[#F6F6F6] rounded-full w-[48px] h-[48px] sm:flex justify-center items-center" style={{boxShadow: '0px 2px 6px 2px rgba(0, 0, 0, 0.15), 0px 1px 2px rgba(0, 0, 0, 0.3)'}} onClick={() => handleErasure()}>
                    ...
                    <button 
                        ...
                        style={{
                            boxShadow: isVoiceActive || status === 'connected' 
                                ? undefined 
